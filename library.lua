    ...
    -- Library element functions
        function library:window(properties)
            local cfg = { 
                ...
                name = properties.name or properties.Name or "ordinary.";
                game_name = properties.gameInfo or properties.game_info or properties.GameInfo or "#1 Closet Cheating Script";
